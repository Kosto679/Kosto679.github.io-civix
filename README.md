...
Static showcase site for Civix: Greek legislation summaries in plain language.
...
With the Expo app running at `http://127.0.0.1:8081`:
...
Then redeploy from the Civix monorepo (`website/scripts/deploy.ps1`).
